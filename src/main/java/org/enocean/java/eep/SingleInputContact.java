...
public class SingleInputContact implements EEPParser {
    ...
    public static final String PARAMETER_LEARN_BUTTON = "LEARN_BUTTON";
    ...
    public Map<EnoceanParameterAddress, Value> parsePacket(BasicPacket packet) {
        ...
        if (packet instanceof RadioPacket1BS) {
            ...
            map.put(new EnoceanParameterAddress(radioPacket1BS.getSenderId(), PARAMETER_LEARN_BUTTON), learnButton);
        }
        return map;
    }
}
