...
public class BitsTest {
    ...
    public void testSetBitsOfBytes() {
        ...
        assertTrue(Bits.setBitsOfBytes(0xAB, data, 0, 7, 0, 0));
        assertTrue(Bits.setBitsOfBytes(0xCD, data, 1, 7, 1, 0));
        assertTrue(Bits.setBitsOfBytes(0xEF, data, 2, 7, 2, 0));
        assertEquals((byte) 0xAB, data[0]);
        assertEquals((byte) 0xCD, data[1]);
        assertEquals((byte) 0xEF, data[2]);

        assertTrue(Bits.setBitsOfBytes(0x01, data, 0, 7, 0, 4));
        assertTrue(Bits.setBitsOfBytes(0x02, data, 0, 3, 0, 0));
        assertTrue(Bits.setBitsOfBytes(0x03, data, 1, 7, 1, 4));
        assertTrue(Bits.setBitsOfBytes(0x04, data, 1, 3, 1, 0));
        assertTrue(Bits.setBitsOfBytes(0x05, data, 2, 7, 2, 4));
        assertTrue(Bits.setBitsOfBytes(0x06, data, 2, 3, 2, 0));
        assertEquals((byte) 0x12, data[0]);
        assertEquals((byte) 0x34, data[1]);
        assertEquals((byte) 0x56, data[2]);

        assertTrue(Bits.setBitsOfBytes(0x4F5E6D, data, 0, 7, 2, 0));
        assertEquals((byte) 0x4F, data[0]);
        assertEquals((byte) 0x5E, data[1]);
        assertEquals((byte) 0x6D, data[2]);
        assertTrue(Bits.setBitsOfBytes(0x00, data, 1, 3, 2, 4));
        assertEquals((byte) 0x4F, data[0]);
